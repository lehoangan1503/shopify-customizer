...
- **ABSOLUTE RULE**: **NEVER use `any` type** - create proper interfaces
...
### Type Patterns Used
- Supabase generated types for database
- TanStack Query typed hooks
- Expo Router typed routes
- NativeWind className (string type)

### Where to Find Existing Types
- `src/types/` - Custom type definitions
- `src/api/` - API response types
- Check existing files for patterns before creating new types
