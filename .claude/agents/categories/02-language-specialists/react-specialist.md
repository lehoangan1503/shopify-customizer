...
- **Framework**: React Native 0.76.7 (NOT web React) + Expo 52
- **Router**: Expo Router 4 (file-based routing in `app/` directory)
- **Language**: TypeScript (strict mode - NEVER use `any`)
- **Styling**: NativeWind (Tailwind for RN) - use `className`, always include `dark:` variants
- **UI Components**: @rn-primitives (NOT web component libraries)
- **State/Data**: TanStack Query for server state
- **Path Alias**: `@/*` → project root

### React Native Specifics
- Use `View`, `Text`, `Pressable` (NOT `div`, `span`, `button`)
- Use NativeWind `className` (NOT StyleSheet or inline styles)
- Follow patterns in `src/components/` directory
