...
### Security Audit Focus Areas (Project-Specific)
...
**Use MCP Tool for Checks**
- Run `mcp__supabase__get_advisors` with type "security" to get automated security findings
