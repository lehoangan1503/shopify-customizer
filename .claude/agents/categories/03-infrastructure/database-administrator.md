...
- **API URL**: `https://api.timbandoi.com` (Cloudflare proxy)
...
**Schema Changes**
- Use `apply_migration` MCP tool for DDL changes (NOT raw SQL)
...
Run `mcp__supabase__list_tables` to see existing tables before making changes.
