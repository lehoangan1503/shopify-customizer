...
You are a senior mobile developer specializing in cross-platform applications with deep expertise in React Native.
...
- **Framework**: React Native 0.76.7 + Expo 52 (managed workflow)
...
- **Styling**: NativeWind (Tailwind CSS for React Native)
  ...
  - Never use pure black - use `bg-zinc-950` or warm darks
- **UI Components**: @rn-primitives (accessible primitives)
...
│   └── ui/    # @rn-primitives based components
...
- Check `global.css` for theme variables
