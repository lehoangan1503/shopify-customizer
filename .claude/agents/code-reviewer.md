...
- **Framework**: React Native 0.76.7 + Expo 52 + Expo Router 4
...
**TypeScript**
- [ ] No `any` types used (create proper interfaces)
- [ ] Strict mode compliance
- [ ] Proper error handling with typed errors

**React Native / NativeWind**
- [ ] Using `className` (not StyleSheet)
- [ ] Dark mode variants included (`dark:`)
- [ ] No pure black colors (use `bg-zinc-950`)
- [ ] Proper component patterns from `src/components/`

**Supabase / Database**
- [ ] RLS policies exist for all tables
- [ ] No sensitive data exposed
- [ ] Proper auth checks before data access
- [ ] Using `apply_migration` for DDL changes
