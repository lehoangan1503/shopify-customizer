      ...
      loadedModel.traverse((child) => {
        ...
        mats.forEach((m, idx) => {
          if (m && m.name === mat.name) {
            // MeshPhysicalMaterial - LỚP PHỦ THỦY TINH DÀY
            const glassMat = new THREE.MeshPhysicalMaterial({
              map: tex,
              color: m.color,
              roughness: 0.01,           // Siêu bóng như kính
              metalness: 0.0,
              clearcoat: 1.0,            // Lớp phủ bóng tối đa
              clearcoatRoughness: 0.005, // Clearcoat cực bóng
              reflectivity: 1.0,         // Phản chiếu tối đa
              ior: 1.52,                 // Index of refraction (kính crown ~1.52)
              thickness: 1.5,            // Lớp phủ DÀY hơn
              specularIntensity: 1.2,    // Specular mạnh hơn
              specularColor: new THREE.Color(0xffffff),
              sheen: 0.3,                // Thêm sheen để bóng hơn
              sheenRoughness: 0.2,
